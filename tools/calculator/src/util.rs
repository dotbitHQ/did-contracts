...
pub fn calc_yearly_price_in_ckb(yearly_price: u64, quote: u64, discount: u32) -> u64 {
    let total;
...
pub fn calc_duration_from_paid(paid: u64, yearly_price: u64, quote: u64, discount: u32) -> u64 {
    let yearly_price_in_ckb = calc_yearly_price_in_ckb(yearly_price, quote, discount);
    ...
    let ret = paid * 365 / yearly_price_in_ckb * 86400;
    println!(
        "duration({}) = profit({}) * 365 / price_in_CKB({}) * 86400",
        ret, paid, yearly_price_in_ckb
    );
