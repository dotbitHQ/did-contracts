...
export class AccountCellDataV1 {
  ...
  validate(compatible = false) {
    ...
    new Records(this.view.buffer.slice(offsets[5], offsets[6]), { validate: false }).validate();
  }
...
export function SerializeAccountCellDataV1(value) {
  const buffers = [];
  ...
  buffers.push(SerializeUint64(value.updated_at));
...
export function SerializeSubAccountV1(value) {
  const buffers = [];
