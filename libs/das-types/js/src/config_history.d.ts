...
export interface ConfigCellMainV1Type {
  status: Uint8Type;
  type_id_table: TypeIdTableV1Type;
  das_lock_out_point_table: DasLockOutPointTableV1Type;
}

export interface TypeIdTableV1Type {
  account_cell: HashType;
  apply_register_cell: HashType;
  bidding_cell: HashType;
  income_cell: HashType;
  on_sale_cell: HashType;
  pre_account_cell: HashType;
  proposal_cell: HashType;
}

export interface DasLockOutPointTableV1Type {
...
export interface ConfigCellMainV2Type {
  status: Uint8Type;
  type_id_table: TypeIdTableV2Type;
  das_lock_out_point_table: DasLockOutPointTableV1Type;
}

export interface TypeIdTableV2Type {
  account_cell: HashType;
  apply_register_cell: HashType;
...
export interface ConfigCellMainV3Type {
  status: Uint8Type;
  type_id_table: TypeIdTableV3Type;
  das_lock_out_point_table: DasLockOutPointTableV1Type;
}

export interface TypeIdTableV3Type {
  account_cell: HashType;
  apply_register_cell: HashType;
  balance_cell: HashType;
  income_cell: HashType;
...
export interface ConfigCellMainV4Type {
  status: Uint8Type;
  type_id_table: TypeIdTableV4Type;
  das_lock_out_point_table: DasLockOutPointTableV1Type;
}

export interface ConfigCellMainV5Type {
  status: Uint8Type;
  type_id_table: TypeIdTableV4Type;
  das_lock_out_point_table: DasLockOutPointTableType;
}

export interface TypeIdTableV4Type {
  account_cell: HashType;
  apply_register_cell: HashType;
  balance_cell: HashType;
  income_cell: HashType;
...
export interface ConfigCellMainV6Type {
  status: Uint8Type;
  type_id_table: TypeIdTableV5Type;
  das_lock_out_point_table: DasLockOutPointTableType;
}

export interface TypeIdTableV5Type {
  account_cell: HashType;
  apply_register_cell: HashType;
  balance_cell: HashType;
  income_cell: HashType;
...
export interface ConfigCellMainV7Type {
  status: Uint8Type;
  type_id_table: TypeIdTableV5Type;
  das_lock_out_point_table: DasLockOutPointTableType;
}
...
export interface ConfigCellProfitRateV2Type {
  inviter: Uint32Type;
  channel: Uint32Type;
  proposal_create: Uint32Type;
  proposal_confirm: Uint32Type;
  income_consolidate: Uint32Type;
  sale_inviter: Uint32Type;
  sale_channel: Uint32Type;
  sale_das: Uint32Type;
}

export interface ConfigCellSecondaryMarketV1Type {
  min_sale_price: Uint64Type;
  sale_expiration_limit: Uint64Type;
  sale_description_bytes_limit: Uint32Type;
}

export interface ConfigCellSecondaryMarketV2Type {
...
export interface ConfigCellSubAccountV1Type {
  basic_capacity: Uint64Type;
  prepared_fee_capacity: Uint64Type;
...
export class ConfigCellMainV1 {
  ...
  getStatus(): Uint8;
  getTypeIdTable(): TypeIdTableV1;
  getDasLockOutPointTable(): DasLockOutPointTableV1;
}

export function SerializeTypeIdTableV1(value: TypeIdTableV1Type): ArrayBuffer;
...
export function SerializeDasLockOutPointTableV1(value: DasLockOutPointTableV1Type): ArrayBuffer;
...
export function SerializeConfigCellMainV2(value: ConfigCellMainV2Type): ArrayBuffer;
export class ConfigCellMainV2 {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  getStatus(): Uint8;
  getTypeIdTable(): TypeIdTableV2;
  getDasLockOutPointTable(): DasLockOutPointTableV1;
}

export function SerializeTypeIdTableV2(value: TypeIdTableV2Type): ArrayBuffer;
...
export function SerializeConfigCellMainV3(value: ConfigCellMainV3Type): ArrayBuffer;
export class ConfigCellMainV3 {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  getStatus(): Uint8;
  getTypeIdTable(): TypeIdTableV3;
  getDasLockOutPointTable(): DasLockOutPointTableV1;
}

export function SerializeTypeIdTableV3(value: TypeIdTableV3Type): ArrayBuffer;
...
export function SerializeConfigCellMainV4(value: ConfigCellMainV4Type): ArrayBuffer;
export class ConfigCellMainV4 {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  getStatus(): Uint8;
  getTypeIdTable(): TypeIdTableV4;
  getDasLockOutPointTable(): DasLockOutPointTableV1;
}

export function SerializeConfigCellMainV5(value: ConfigCellMainV5Type): ArrayBuffer;
...
export function SerializeTypeIdTableV4(value: TypeIdTableV4Type): ArrayBuffer;
...
export function SerializeConfigCellMainV6(value: ConfigCellMainV6Type): ArrayBuffer;
export class ConfigCellMainV6 {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  getStatus(): Uint8;
  getTypeIdTable(): TypeIdTableV5;
  getDasLockOutPointTable(): DasLockOutPointTable;
}

export function SerializeTypeIdTableV5(value: TypeIdTableV5Type): ArrayBuffer;
...
export function SerializeConfigCellMainV7(value: ConfigCellMainV7Type): ArrayBuffer;
...
export function SerializeConfigCellProfitRateV2(value: ConfigCellProfitRateV2Type): ArrayBuffer;
export class ConfigCellProfitRateV2 {
  ...
  getProposalConfirm(): Uint32;
  getIncomeConsolidate(): Uint32;
  getSaleInviter(): Uint32;
  getSaleChannel(): Uint32;
  getSaleDas(): Uint32;
}

export function SerializeConfigCellSecondaryMarketV1(value: ConfigCellSecondaryMarketV1Type): ArrayBuffer;
export class ConfigCellSecondaryMarketV1 {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  getMinSalePrice(): Uint64;
  getSaleExpirationLimit(): Uint64;
  getSaleDescriptionBytesLimit(): Uint32;
}

export function SerializeConfigCellSecondaryMarketV2(value: ConfigCellSecondaryMarketV2Type): ArrayBuffer;
...
export function SerializeConfigCellSubAccountV1(value: ConfigCellSubAccountV1Type): ArrayBuffer;
