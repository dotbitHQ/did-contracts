...
pub enum Error {
    ...
    AccountCellSaleStatusMustNormalStatus,
    AccountCellSaleStatusMustSellingStatus,
    AccountCellSaleStatusNotAllow,
    AccountSaleCellNumberInvalid = -70,
    AccountSaleCellMissing,
    AccountSaleCellAccountCellMustOne,
    ...
    AccountSaleCellBuyParamInvalid,
    AccountSaleCellIncomeCellMissing,
    AccountSaleCellIncomeCellRecordsInvalid,
    AccountSaleCellIncomeCellRecordsProfitErr,
    AccountSaleCellIncomeCellTotalCapacityErr,
    AccountSaleEditPriceEqualError,
    AccountSaleInputAccountCellNumberInvalid,
    AccountSaleOutputDasLockCellInvalid,
    AccountSaleMissingErr,
    AccountSaleChangePriceError1,
    AccountSaleChangePriceError2,
    SystemOff = -1,
}
