...
pub fn das_lock() -> Script {
    ...
    let das_lock: ScriptLiteral = ScriptLiteral {
        code_hash: [
            49, 196, 64, 138, 2, 214, 213, 185, 252, 209, 202, 139, 84, 44, 8, 117, 92, 132, 166, 38, 94, 14, 1, 41,
            224, 88, 10, 78, 144, 77, 65, 141,
        ],
        hash_type: ScriptHashType::Type,
        args: Vec::new(),
    };
...
pub const CONFIG_CELL_TYPE: ScriptLiteral = ScriptLiteral {
    code_hash: [
        71, 79, 234, 0, 45, 170, 253, 41, 211, 170, 65, 67, 87, 21, 112, 240, 184, 48, 74, 181, 212, 38, 29, 159, 158,
        216, 19, 83, 65, 101, 99, 33,
    ],
    hash_type: ScriptHashType::Type,
    args: Vec::new(),
};
