...
test_with_generator!(test_account_renew, || {
...
challenge_with_generator!(
    challenge_account_renew_modify_owner,
...
challenge_with_generator!(
    challenge_account_renew_less_than_one_year,
...
challenge_with_generator!(
    challenge_account_renew_payment_less_than_one_year,
    Error::AccountCellRenewDurationMustLongerThanYear,
    || {
        let (mut template, timestamp, owner, sender) = before_each();
...
challenge_with_generator!(
    challenge_account_renew_payment_less_than_increment,
...
challenge_with_generator!(challenge_account_renew_change_amount, Error::ChangeError, || {
    let (mut template, timestamp, owner, sender) = before_each();
...
challenge_with_generator!(challenge_account_renew_change_owner, Error::ChangeError, || {
