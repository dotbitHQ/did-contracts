...
test_with_generator!(test_pre_register_account_released, || {
    ...
    template.push_config_cell_derived_by_account("fzmb7eku", true, 0, Source::CellDep);
...
test_with_generator!(test_pre_register_account_unreleased_with_super_lock, || {
    ...
    template.push_config_cell_derived_by_account("g0xhlqew", true, 0, Source::CellDep);
