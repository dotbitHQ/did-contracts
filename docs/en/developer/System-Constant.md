...
> ⚠️ To facilitate maintenance, the numbering space of ConfigCellXXX is between 100 ~ 199999, that is, args >= 100 && args <= 199999.
...
> ⚠️ In order to facilitate maintenance, ConfigCellCharSetXXX always maintains the form minus 100000 equal to the following CharSet constant, so the following conversion method can be directly used:>
